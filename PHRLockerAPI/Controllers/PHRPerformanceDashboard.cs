...
namespace PHRLockerAPI.Controllers
{
    ...
    public class PHRPerformanceDashboard : ControllerBase
    {
        ...
        public VMGetTotalPopulationPhrPerModel gettotalPopulationcountphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.gettotalpopulationcount_phrper(' " + InstitutionParam + " ',' " + para + " ')";
        ...
        public GetIndividualScreenedGenderWisePhrPerModel getindividualscreenedgenderwisephrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getscreenedgenderwise_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetMTMTargetUniqueScreenedPhrPerModel[] getmtmtargetuniquescreenedphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getmtmtargetscreened_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetFamilyResidentailStatusPhrPerModel getfamilyresidentailstatusphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getfamilyresidentailstatus_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetMembersAddedPhrPerModel getmembersaddedphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getmembersadded_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetFamiliesAddedPhrPerModel getfamiliesaddedphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getfamiliesadded_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetFamiliesUpdatedPhrPerModel getfamiliesUpdated ([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getfamiliesupdated_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetPopulationGivenConsentPhrPerModel getpopulationgivenconsentphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getpopulationgivenconsent_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetScreenedOnlyOnceAndMultipleTimesPhrPerModel[] getscreenedonlyonceandmultipletimesphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getscreenedonlyonemultipletimes_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetNCDTargetUniqueScreenedPhrPerModel[] getncdtargetuniquescreenedphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getncdtargetuniquescreened_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetPopulationMappedStreetsPhrPerModel getpopulationmappedstreetsphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getpopulationmappedstreets_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetCMCHISBeneficiariesPhrPerModel getcmchisbeneficiaries([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getcmchisbeneficiaries_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetCongenitalAnomalyPhrPerModel getcongenitalanomalyphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getcongenitalanomaly_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetScreenedLastSevenDaysPhrPerModel[] getscreenedlastsevendaysphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getscreenedlastsevendays_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetSchoolTargetUniqueScreeningPhrPerModel[] getschoolargetuniquescreenedphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getschooltargetuniquescreened_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetAadhaarLinkedMembersPhrPerModel getaadhaarlinkedmembersphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getaadhaarlinkedmembers_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetUDIDLinkedMembersPhrPerModel getudidlinkedmembersphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getudidlinkedmembers_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetDisabilityBeneficiariesPhrPerModel getdisabilitybeneficiariesphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getdisabilitybeneficiaries_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetIndividualScreeningsPhrPerModel getindividualscreeningsphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getindividualscreenings_phrper(' " + InstitutionParam + " ',' " + para + " ')";
        ...
        public VMGetIndividualReceivedDrugsPhrPerModel getindividualreceiveddrugsphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getindividualreceiveddrugs_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetTotalConfirmedMTMBeneficiaryPhrPerModel gettotalconfirmedmtmbeneficiaryphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.gettotalconfirmedmtmbeneficiary_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetFacilityWiseScreeningPhrPerModel[] getfacilitywiseScreeningphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getfacilitywisescreening_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetPopulationRDMNDStatusPhrPerModel[] getpopulationrdmndstatusphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmd.CommandText = "SELECT * FROM public.getpopulationrdmndstatus_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
            ...
            if(RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getpopulationrdmndstatus1_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
            ...
            if (RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getpopulationrdmndstatus2_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
            ...
            if (RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getpopulationrdmndstatus3_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
            ...
            if (RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getpopulationrdmndstatus4_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetMTMBeneficiariesPhrPerModel getmtmbeneficiariesphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getmtmbeneficiaries_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
            ...
            while (drInner.Read())
            {
                ...
                VM.Both = drInner["diahyperboth"].ToString();
            }
        ...
        public VMGetPBSConditionScreeningPhrPerModel[] getpbsconditionscreeningphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getpbsconditionscreening_phrper(' " + CommaParam + " ',' " + InstitutionParams + " ',' " + InstitutionPara + " ',' " + CommunityParam + " ')";
        ...
        public VMGetPopulationVerifiedNonVerifiedStatusPhrPerModel[] getpopulationverifiednonverifiedstatusphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmd.CommandText = "SELECT * FROM public.getpopulationverifiednonverifiedstatus_phrper('" + InstitutionParam + " ',' " + CommunityParam + " ')";
            ...
            if(RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getpopulationverifiednonverifiedstatus1_phrper('" + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetIndividualScreenedAgeWisePhrPerModel[] getindividualscreenedagewisephrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getindividualscreenedagewise_phrper('" + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetLabTestPhrPerModel[] getlabtestphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getlabtest_phrper('" + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetScreenedVillageTypeWisePhrPerModel[] getscreenedvillagetypewisephrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getscreenedVillagetypewise_phrper('" + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetReferredSplitUpPhrPerModel[] getreferredsplitupphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getreferredsplitup_phrper('" + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetUHCConditionScreeningPhrPerModel[] getuhcconditionscreeningphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getuhcconditionscreening_phrper(' " + CommaParam + " ',' " + InstitutionParams + " ',' " + InstitutionPara + " ',' " + CommunityParam + " ')";
        ...
        public VMGetDrugsIssuedPhrPerModel[] getdrugsissuedphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getdrugsissued_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetRoleBasedScreeningPhrPerModel[] getrolebasedscreeningphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmdInner.CommandText = "SELECT * FROM public.getrolebasedscreening_phrper(' " + InstitutionParam + " ',' " + CommunityParam + " ')";
        ...
        public VMGetPHRHealthPhrPerModel[] getphrhealthphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmd.CommandText = "SELECT * FROM public.getphrhealth_phrper(' " + CommunityParam + " ')";
            ...
            if (RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getphrhealth1_phrper(' " + CommunityParam + " ')";
            ...
            if (RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getphrhealth2_phrper(' " + CommunityParam + " ')";
            ...
            if (RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getphrhealth3_phrper(' " + CommunityParam + " ')";
            ...
            if (RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getphrhealth4_phrper(' " + CommunityParam + " ')";
            ...
            if (RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getphrhealth5_phrper(' " + CommunityParam + " ')";
            ...
            if (RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getphrhealth6_phrper(' " + CommunityParam + " ')";
            ...
            if (RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getphrhealth7_phrper(' " + CommunityParam + " ')";
            ...
            if (RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getphrhealth8_phrper(' " + CommunityParam + " ')";
            ...
            if (RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getphrhealth9_phrper(' " + CommunityParam + " ')";
        ...
        public VMGetPHRMTMPhrPerModel[] getphrmtmphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmd.CommandText = "SELECT * FROM public.getphrmtm_phrper(' " + CommunityParam + " ')";
            NpgsqlDataReader drInner = cmd.ExecuteReader();
            ...
            if (RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getphrmtm1_phrper(' " + CommunityParam + " ')";
            ...
            if (RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getphrmtm2_phrper(' " + CommunityParam + " ')";
            ...
            if (RList.Count > 0)
            {
                ...
                //cmdInner.CommandText = "SELECT adm.district_name,adm.district_gid,ahm.hud_name,ahm.hud_gid,abm.block_name,abm.block_gid,avm.village_name,avm.village_gid,\r\ncount(*) FILTER (WHERE hs.screening_values->>'rbs' < '140' AND hs.screening_values->>'dm_screening' = 'Known DM' and \r\n((screening_values->>'dia_bp')::numeric < 90 OR (screening_values->>'sys_bp')::numeric < 140) \r\nAND hs.screening_values->>'ht_screening' = 'Known HT') AS controlled_both,\r\ncount(*) FILTER (WHERE hs.screening_values->>'rbs' < '140' AND hs.screening_values->>'dm_screening' = 'Known DM') AS controlled_diabetes_mellitus,\r\ncount(*) FILTER (WHERE ((screening_values->>'dia_bp')::numeric < 90 OR (screening_values->>'sys_bp')::numeric < 140) \r\nAND hs.screening_values->>'ht_screening' = 'Known HT') AS controlled_hypertension\r\nFROM address_village_master as avm\r\nINNER JOIN family_member_master as fmm ON avm.village_id = fmm.village_id\r\nINNER JOIN address_district_master as adm ON fmm.district_id = adm.district_id\r\nINNER JOIN address_hud_master as ahm ON fmm.hud_id = ahm.hud_id\r\nINNER JOIN address_block_master as abm ON fmm.block_id = abm.block_id\r\nINNER JOIN health_screening as hs ON fmm.member_id = hs.member_id " + CommunityParam  + " GROUP BY adm.district_name,adm.district_gid,ahm.hud_name,ahm.hud_gid,abm.block_name,abm.block_gid,avm.village_name,avm.village_gid LIMIT 4999";
                cmdInner.CommandText = "SELECT * FROM public.getphrmtm3_phrper(' " + CommunityParam + " ')";
        ...
        public VMGetStaffHealthPhrPerModel[] getstaffhealthphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            //cmd.CommandText = "SELECT adm.district_name, adm.district_gid, ahm.hud_name, ahm.hud_gid, abm.block_name, abm.block_gid, avm.village_name, avm.village_gid,\r\n       CASE WHEN fr.facility_level = 'PHC' THEN ftm.facility_type_name END AS phc,\r\n       CASE WHEN fr.facility_level = 'HSC' THEN ftm.facility_type_name END AS hsc\r\nFROM family_member_master AS fmm\r\nINNER JOIN address_district_master AS adm ON fmm.district_id = adm.district_id\r\nINNER JOIN address_hud_master AS ahm ON fmm.hud_id = ahm.hud_id\r\nINNER JOIN address_block_master AS abm ON fmm.block_id = abm.block_id\r\nINNER JOIN address_village_master AS avm ON fmm.village_id = avm.village_id\r\nINNER JOIN facility_registry AS fr ON fmm.facility_id = fr.facility_id\r\nINNER JOIN facility_type_master AS ftm ON fr.facility_type_id = ftm.facility_type_id\r\nWHERE fr.facility_level IN ('PHC', 'HSC') " + CommunityParam + " GROUP BY adm.district_name, adm.district_gid, ahm.hud_name, ahm.hud_gid, abm.block_name, abm.block_gid, avm.village_name, avm.village_gid, fr.facility_level, ftm.facility_type_name LIMIT 4999";
            cmd.CommandText = "SELECT * FROM public.getstaffhealth_phrper(' " + CommunityParam + " ')";
            ...
            if (RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getstaffhealth1_phrper(' " + CommunityParam + " ')";
            ...
            if (RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getstaffhealth2_phrper(' " + CommunityParam + " ')";
            ...
            if (RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getstaffhealth3_phrper(' " + CommunityParam + " ')";
            ...
            if (RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getstaffhealth4_phrper(' " + CommunityParam + " ')";
            ...
            if (RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getstaffhealth5_phrper(' " + CommunityParam + " ')";
        ...
        public VMGetStaffMTMPhrPerModel[] getstaffmtmphrper([FromQuery] FilterpayloadModel F)
        {
            ...
            cmd.CommandText = "SELECT * FROM public.getstaffmtm_phrper(' " + CommunityParam + " ')";
            ...
            if (RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getstaffmtm1_phrper(' " + CommunityParam + " ')";
            ...
            if (RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getstaffmtm2_phrper(' " + CommunityParam + " ')";
            ...
            if (RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getstaffmtm3_phrper(' " + CommunityParam + " ')";
            ...
            if (RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getstaffmtm4_phrper(' " + CommunityParam + " ')";
            ...
            if (RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getstaffmtm5_phrper(' " + CommunityParam + " ')";
            ...
            if (RList.Count > 0)
            {
                ...
                cmdInner.CommandText = "SELECT * FROM public.getstaffmtm6_phrper(' " + CommunityParam + " ')";
